...
class PsionicsTab(QWidget):
    ...
    def _build_ui(self) -> None:
        ...
        self._total_pp = QSpinBox(); self._total_pp.setRange(0, 9999)
        self._spent_pp = QSpinBox(); self._spent_pp.setRange(0, 9999)
        ...
        rm.clicked.connect(lambda: [self._powers_list.takeItem(self._powers_list.row(i))
